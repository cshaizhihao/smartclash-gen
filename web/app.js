const STORAGE_KEY = 'smartclash-web-v1341';
const APP_VERSION = '0.13.41';
...
const el = {
  ...
  subLinkCard: document.getElementById('subLinkCard'),
  subLinkCardAnchor: document.getElementById('subLinkCardAnchor'),
